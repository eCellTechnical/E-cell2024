    ...
    <div className="w-full h-full text-black dark:text-white bg-white dark:bg-black">
      <div className="flex">
        ...
        <div
          className={`${
            (tab == 0 || tab == 1) && "hidden"
          } flex w-full flex-col justify-start items-center md:py-11 px-8 pb-11 min-h-[100vh] md:p-0`}
        >
          <div className="w-full pt-[13vh] text-center">
              ...
              <div className="flex flex-wrap w-full justify-around mt-5 md:mt-11 mb-8 p-8 md:p-8">
                {paymentInfo.map((payment) => {
                  ...
                  return (
                    <div
                      key={payment._id}
                      className="p-5 px-11 shadow-2xl rounded-lg flex flex-col bg-[#9ea4ff] justify-center items-center border-white border-4 mb-5 text-center text-[1.1em] text-black w-[80%] md:w-[30%]"
                    >
                      <p>
