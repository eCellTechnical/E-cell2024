...
export default function EventSection() {
  return (
    <section className="relative mt-16 my-12 bg-gradient-to-br from-[#211E3F]/80 via-[#1a1733]/80 to-black/80 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl text-white py-24 px-6 sm:px-10 lg:px-16 overflow-hidden w-[83vw] mx-auto">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8">
          <div className="relative overflow-hidden rounded-2xl">
            <img
              src="https://kits.kitmama.top/beatfa/wp-content/uploads/2025/09/New-Project-2025-07-20T125601.154.jpg"
              alt="event"
