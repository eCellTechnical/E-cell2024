        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Discover What's Coming in Our Event Lineup
            </h2>
            
            <p className="text-gray-300 mb-10">
              Get ready to be inspired as we spotlight the brilliant minds and thought leaders who will be
              gracing our stages. From insightful discussions to groundbreaking presentations, our
              events promise to ignite your curiosity and spark meaningful conversations.
            </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-5">
              <div className="flex items-center gap-4">
                <h3 className="text-4xl font-bold text-[#00FCB8]">500+</h3>
                <span className="text-gray-300">Already Registered</span>
              </div>
              
              <motion.button 
                className="px-6 py-3 bg-[#00FCB8] hover:bg-opacity-80 text-black font-medium rounded-full flex items-center gap-2"
