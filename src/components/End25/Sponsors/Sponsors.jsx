      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 font-modern">
          <div className="inline-block px-4 py-2 bg-opacity-20 bg-[#00FCB8] rounded-md mb-3">
            <p className="text-[#00FCB8] font-medium tracking-wider">OUR PARTNERS</p>
          </div>
        ...
        <div className="text-center mt-12">
          <button className="px-8 py-3 bg-[#00FCB8] text-gray-900 font-semibold rounded-full hover:bg-opacity-90 transition-all duration-300 shadow-md hover:shadow-lg">
            Become a Sponsor
          </button>
        </div>
      </div>
