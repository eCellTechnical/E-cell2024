      ...
      {isEndeavour.pathname.slice(1, 10) != "endeavour" ? (
        ...
        <div className="relative">
              ...
              {!localStorage.getItem("userId") ? (
                <>
                  <Link to="/endeavour/login">
                    <button className="border-2 py-2 px-6 border-[#6d6d6d] dark:border-white text-black dark:text-white font-semibold rounded-full ">
                      Sign In
                    </button>
                  </Link>
          ...
          <div
            ...
            } transition-all duration-200 lg:hidden   w-[100vw] h-[94.5vh] fixed bg-[#ffffff] dark:bg-[#090909] text-[#000] dark:text-white mt-[8.6vh] flex flex-col justify-between py-36 items-center text-5xl font-bold z-20`}
          >
