  ...
  return (
    <>
      ...
      isEndeavour.pathname.slice(1, 18) !== "ideatex/register" ? (
        ...
        <div className="footer z-10   border-white/65 bg-black text-white border-t-[1px] border-t-[#b1b1b17d]">
          <div className="upperfoot bg-black z-10 p-8 border-b-[1px] border-b-[#8a8a8a92]">
            <div className="box flex flex-col lg:flex-col items-center lg:items-start">
              <h4 className="text-lg font-bold mb-5">Subscribe to E-Cell</h4>
              ...
              <div className="input-group w-[90%] flex flex-row mb-5 mt-2 lg:mt-5 justify-center items-center">
                <input
                  type="email"
                  className="md:mr-3 !mb-0 w-full !border-0 !border-b-2  !rounded-none !border-b-white bg-transparent outline-none p-1"
                  id="Email"
                  name="Email"
                  placeholder="example@gmail.com"
                  autoComplete="off"
                />
                <p className="rounded-lg p-5 md:p-2 subscribe !cursor-pointer [transition:_all_0.1s_linear;] hover:[transform:_translateY(-2px);]">
                  <span className="!cursor-pointer  font-medium  hover:[text-shadow:_#4d55ba_3px_3px;]">
                    Subscribe
                  </span>
                </p>
              </div>
              <div className="handle flex flex-row items-center justify-between w-[70%] lg:w-[50%] ">
                <a
                  ...
                  rel="noreferrer"
                >
                  <FaInstagram className=" h-8 w-8 text-white hover:text-[#4d55ba] cursor-pointer transition-all duration-150" />
                </a>
                {/* <a href="#" target="_blank" rel="noreferrer">
                <FaFacebook className=" h-7 w-7 test-black dark:text-white hover:text-[#4d55ba] cursor-pointer transition-all duration-150" />
              </a>
              <a href="#" target="_blank" rel="noreferrer">
                ...
                <a
                  ...
                  rel="noreferrer"
                >
                  <FaLinkedinIn className=" h-7 w-7 text-white hover:text-[#4d55ba] cursor-pointer transition-all duration-150" />
                </a>
                <a
                  href="https://www.youtube.com/@ecellkiet5297/videos"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaYoutube className=" h-7 w-7 text-white hover:text-[#4d55ba] cursor-pointer transition-all duration-150" />
                </a>
              </div>
            </div>
            ...
            <div className="footbox mt-6 lg:mt-0 ">
              <div className="box mr-8 flex flex-col items-center lg:items-start">
                ...
                <p className="mt-4 mb-4 font-medium">
                  Mail us at :-{" "}
                  <span className="font-light">ecell@kiet.edu</span>
                </p>
                {/* <p className="mb-4 font-semibold dark:font-medium">
                Phone No. :-{" "}
                <span className="font-medium dark:font-light">
              ...
              <div className="box ">
                ...
                <div className="upper flex flex-row justify-between items-start w-[80%]">
                  <div className="inner ">
                    <a
                      onClick={() => history("/discover")}
                      className="!flex !flex-row items-center justify-normal mb-2 font-medium cursor-pointer"
                    >
                      <img
                        src={greaterThanDark}
                        alt=""
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="!flex !flex-row items-center justify-normal font-medium mb-2 cursor-pointer"
                    >
                      <img
                        src={greaterThanDark}
                        alt=""
          ...
          <div className="lowerfoot bg-black z-10 !w-[100vw] font-medium text-xs md:text-sm dark:font-medium flex justify-between">
            <h3 className="w-1/2 pl-8">IGNITEX SOLUTIONS PVT. LTD.</h3>
            <h3 className="w-1/2 text-right pr-10 border-l-[1px] border-[#b6b6b6]">
              Made with ❤️ E-Cell 2024
            </h3>
